...
Yasiv.facebookGraphBuilder = function(graph, FB, layout) {
    ...
    return {
        buildMyFriendsGraph : function() {
           ...
           FB.api('/fql', {q : 'SELECT uid, name, friend_count, sex,profile_url, pic_square FROM user WHERE uid = me() OR uid IN (SELECT uid2 FROM friend WHERE uid1 = me()) and is_app_user = 1'}, function(response){
